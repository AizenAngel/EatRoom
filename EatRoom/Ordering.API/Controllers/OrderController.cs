...
namespace Ordering.API.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        [HttpGet("{username}")]
        [ProducesResponseType(typeof(IEnumerable<OrderModelView>), StatusCodes.Status200OK)]
        public async Task<ActionResult<IEnumerable<OrderModelView>>> GetOrdersByUsername(string username)
        {
